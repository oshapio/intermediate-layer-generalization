...
This repository contains code to reproduce the experiments from the paper "Earlier layers are often more useful for OOD generalization than the last layer".
